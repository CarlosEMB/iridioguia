...
1) Process the image and use your full visual intelligence to zoom in the iris and identify patterns described in existing resources of iridology and/or Traditional Chinese Medicine.
2) Observe visual characteristics holistically.
3) Infer FOUR emotional/energetic themes.
4) Each theme represents an introspective imbalance.
5) For EACH imbalance, design a Lyria RealTime music configuration
